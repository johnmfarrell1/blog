...
Ruby 2.6 introduced `Enumerable#filter` which clashes with the naming of this concern, so in order to avoid this, its best to rename the filtering method to `filter_by`.
